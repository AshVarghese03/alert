...
class QuitSmokingPage extends StatelessWidget {
  final List<String> messages = [
    ...
    "Think of all the money you'll save by quitting smoking.",
    "Your body will thank you for quitting smoking!",
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            // Custom button in the shape of a cigarette or smoke
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
              ...
              child: Image.asset(
                'assets/cigg.png', // Replace with your image path
                width: 150,
                height: 150,
              ),
            ),
          ...
          children: [
            Column(
              ...
              children: [
                ...
                _buildTipItem(
                  title: 'Go for a Walk',
                  image: 'assets/walking.jpg', // Add path to walking image
                  description:
                ...
                _buildTipItem(
                  ...
                  image: 'assets/family.jpg', // Add path to family image
                  description:
                ...
                _buildTipItem(
                  ...
                  image: 'assets/savings.jpg', // Add path to savings image
                  description:
                ...
                _buildTipItem(
                  title: 'Hit the Gym',
                  image: 'assets/gym.jpg', // Add path to gym image
                  description:
                ...
                _buildTipItem(
                  ...
                  image: 'assets/stamina.jpg', // Add path to stamina image
                  description:
                ...
                _buildTipItem(
                  ...
                  image: 'assets/happiness.jpg', // Add path to happiness image
                  description:
                ...
                _buildTipItem(
                  ...
                  image: 'assets/longevity.jpg', // Add path to longevity image
                  description:
        ...
        child: Column(
          ...
          children: [
            ...
            _buildStatItem(
              ...
              image: 'assets/stat1.png', // Add path to stat1 image
            ),
            _buildStatItem(
              ...
              image: 'assets/stat2.jpg', // Add path to stat2 image
            ),
            _buildStatItem(
              ...
              image: 'assets/stat3.jpeg', // Add path to stat3 image
            ),
            _buildStatItem(
              ...
              image: 'assets/stat4.jpg', // Add path to stat4 image
            ),
          ],
        ),
      ),
  ...
  final List<Map<String, String>> videos = [
    {
      ...
      'thumbnail': 'assets/thumbnail1.webp', // Replace with actual thumbnail image path
    },
    {
      'name': '',
      'url': 'https://www.youtube.com/watch?v=NKE9BQ5QVfE',
      'thumbnail': 'assets/thumbnail2.webp', // Replace with actual thumbnail image path
    },
    {
      'name': '',
      'url': 'https://www.youtube.com/watch?v=B7N9JNa0GJQ',
      'thumbnail': 'assets/thumbnail3.webp', // Replace with actual thumbnail image path
    },
    {
      'name': '',
      'url': 'https://www.youtube.com/watch?v=9C4B26xt9QQ',
      'thumbnail': 'assets/thumbnail4.webp', // Replace with actual thumbnail image path
    },
  ];
